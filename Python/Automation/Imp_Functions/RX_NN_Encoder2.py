...
dec_weights = torch.load("./Imp_Functions/decoder.pt", map_location="cpu")
dec_model.load_state_dict(dec_weights)
dec_model.args = args

input_data = sio.loadmat("Data_Files/RX_Encoded2.mat")
...
hidden_state = sio.loadmat("Data_Files/RX_Hidden1.mat")
...
sio.savemat("Data_Files/RX_Modulated2.mat", output)

hidden = {"hidden": np.array(hidden_state)}
sio.savemat("Data_Files/RX_Hidden2.mat", hidden)
