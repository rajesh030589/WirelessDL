...
input_data = sio.loadmat("Data_Files/TX_Encoded2.mat")
...
input_arr = input_arr.reshape(args.batch_size, 1, 2)
input = torch.cat(
    [
        input_arr,
        torch.zeros((input_arr.shape[0], 1, args.block_len)) + 0.5,
    ],
    dim=2,
)

hidden_state = sio.loadmat("Data_Files/TX_Hidden1.mat")
...
sio.savemat("Data_Files/TX_Modulated2.mat", output)

hidden = {"hidden": np.array(hidden_state)}
sio.savemat("Data_Files/TX_Hidden2.mat", hidden)
