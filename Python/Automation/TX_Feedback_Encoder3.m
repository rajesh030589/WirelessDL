function TX_Feedback_Encoder3()
    ...
    %Frame Data
    C3_Output = zeros(total_msg_symbols, no_of_frames);
    ...
    for n_frame = 1:no_of_frames
        ...
        if strcmp(mod_type, "NN")
            ...
            save('Data_Files/TX_Encoded3.mat', 'encoder_data');
            system('python3 Imp_Functions/TX_NN_Encoder3.py');
            mod_symbols = open("Data_Files/TX_Modulated3.mat");
        ...
        % Frame Data
        C3_Output(:, n_frame) = mod_symbols;
        TX_Out(:, n_frame) = TX;
    end

    % Save Frame Data
    save('Feedback_Files/C3_Output.mat', 'C3_Output');
