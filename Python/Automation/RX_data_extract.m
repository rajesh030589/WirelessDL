function RX_data_extract()
    ...
    Data_Output = zeros(coded_block_len, no_of_blocks, length(st_id_list));
    Frame_Error = zeros(length(st_id_list), 2);
